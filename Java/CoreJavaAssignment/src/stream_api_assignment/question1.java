...
public class question1 {
	...
	List<News> news=Arrays.asList(
			new News(101,"Naruto","Uzumaki","hi"),
			new News(102,"Sasuke","Uchiha","hello"),
			new News(103,"Rock","Lee","Morning"),
			new News(104,"Asuma","shino","Morning")
			);
		Trader t1=new Trader("Hidden Leaf","Chennai");
		Trader t2=new Trader("Hidden Sand","Pune");
		Trader t3=new Trader("Hidden Cloud","Pune");
		Trader t4=new Trader("Hidden water","Nagpur");
